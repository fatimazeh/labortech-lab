...
<!-- Mirrored from themeht.com/template/labortech/html/product-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jul 2023 06:29:44 GMT -->
<head>
...
<section class="page-title parallaxie" data-bg-img="images/blog/07.jpg">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="white-bg p-md-5 p-3 d-inline-block" >
    <h1 class="text-theme">Product <span class="text-black">Cart</span></h1>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 mb-2">
        <div class="card-deck">
          <div class="card p-2 border-secondary mb-2">
            <img src="<?= $row['p_img'] ?>" class="card-img-top" height="250">
            <div class="card-body p-1">
              <h4 class="card-title text-center text-info"><?= $row['p_name'] ?></h4>
              <h5 class="card-text text-center text-danger"><i class="">$</i><?= number_format($row['p_price'],2) ?></h5>
...
<!-- Mirrored from themeht.com/template/labortech/html/product-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jul 2023 06:29:46 GMT -->
</html>