...
<!-- Mirrored from themeht.com/template/labortech/html/contact-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jul 2023 06:29:32 GMT -->
<head>
...
<section class="page-title parallaxie" data-bg-img="images/blog/02.jpg">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="contact-main white-bg shadow-sm p-5">
          <form  method="post" action="save.php">
            ...
            <div class="form-group col-md-6">
              <input id="form_name" type="text" name="fname" class="form-control" placeholder="Name" required="required">
            </div>
            <div class="form-group col-md-6">
              <input id="form_email" type="email" name="email" class="form-control" placeholder="Email" required="required">
            </div>
            <div class="form-group col-md-6">
              <input id="form_phone" type="tel" name="mobile" class="form-control" placeholder="mobile" required="required">
            </div>
            <div class="form-group col-md-12">
              <textarea id="form_message" name="message1" class="form-control" placeholder="Message" rows="3" required="required"></textarea>
            </div>
