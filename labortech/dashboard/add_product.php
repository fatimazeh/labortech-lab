...
if(isset($_POST['padd'])){
    ...
    $imgtm= $_FILES['pimg']['tmp_name'];
    $pcode = $_POST['pcode'];
    $pqty = $_POST['pqty'];

    $sql="INSERT INTO `product`(product_name,product_price,product_image,product_code,product_qty) VALUES ('$pname','$pprice','$img','$pcode','$pqty')";
    move_uploaded_file($imgtm,"../product/".$pimage);
...
<head>
    ...
    <!-- endinject --><link rel="shortcut icon" href="images/favicon.ico" />
</head>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                         <a class="nav-link" href="product-cart.php">
                         <i class="icon-grid menu-icon"></i>
          ...
          <li class="nav-item">
                    <a class="nav-link" href="pages/forms/basic_elements.html">
                            <i class="icon-grid menu-icon"></i>
                            <span class="menu-title">Basic Element</span>
                        </a>
                    </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
                    ...
                    <a class="nav-link" href="pages/samples/error-404.html">
                            <i class="icon-grid menu-icon"></i>
                            <span class="menu-title">404 error</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="pages/samples/error-500.html">
                            <i class="icon-grid menu-icon"></i>
                            <span class="menu-title">500 error</span>
                        </a>
                    </li>
                </ul>
            </nav>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="pcode" class="form-control" 
                                        ...
                                        <button type="submit" name="padd" class="btn btn-primary mr-2">Submit</button>
